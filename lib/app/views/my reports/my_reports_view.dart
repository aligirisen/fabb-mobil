...
class MyReportsView extends StatelessWidget {
  MyReportsView({super.key});
  final MyReportsController controller = Get.put(MyReportsController());
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: GeneralAppDatas.myIncidentList.isEmpty
                                    ? Row(
                                        mainAxisAlignment:
                                    ...
                                    : Container(
                                        ...
                                        child: ListView.builder(
                                          itemCount: GeneralAppDatas
                                              .myIncidentList.length,
                                                        ...
                                                        children: [
                                                                ...
                                                                Row(
                                                                  children: [
                                                                    LikeButton(
                                                                      ...
                                                                      likeCount:
                                                                          GeneralAppDatas.myIncidentList[index].upvoteCount ??
                                                                              0,
                                                                      countBuilder: (int?
                                                                              count,
                                                                          bool
                                                                    ...
                                                                    LikeButton(
                                                                      ...
                                                                      likeCount:
                                                                          GeneralAppDatas.myIncidentList[index].downvoteCount ??
                                                                              0,
                                                                      countBuilder: (int?
                                                                              count,
                                                                          bool
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              GestureDetector(
                                                                onTap: () {
                                                                  controller.deleteIncident(GeneralAppDatas
                                                                      .myIncidentList[
                                                                          index]
                                                                      .incidentId!);
